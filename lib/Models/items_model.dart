...
List<FoodDetail> foodsItems = [
  FoodDetail(
    id: '1',
    image:
        'assets/models/avocado salad.png',
    name: 'Avocado Salad',
    price: 12,
    rate: 4.5,
    kcal: '100',
  ...
  FoodDetail(
      id: '2',
      image:
          'assets/models/royal burger.png',
      name: 'Royal Burger',
      price: 20,
      rate: 5.0,
      kcal: '100',
  ...
  FoodDetail(
    id: '5',
    image:
        "assets/models/protienshake.png",
    name: 'Protein Shake',
    price: 50,
    rate: 4.8,
    kcal: '100',
  ...
  FoodDetail(
    id: '5',
    image: "assets/models/dairymilk.jpg",
    name: 'Dairy Milk',
    price: 05,
    rate: 5.0,
    kcal: '10',
